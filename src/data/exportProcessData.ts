...
export const exportProcessSteps: ExportStep[] = [
  {
    ...
    details: ['Product & purity selection', 'Packaging preference (25 KG standard)', 'Target destination port & timeline', 'Downstream application context'],
  },
  {
    step: '02',
  ...
  },
  {
    ...
    description: 'Cargo is packed into high-grade 25 KG multi-wall poly-lined export bags, palletized if required, and inspected for seaworthiness prior to container stuffing.',
    details: ['25 KG poly-lined export sacks', 'Palletization & shrink-wrap on request', 'Container loading supervision', 'Desiccant placement for moisture control'],
  },
  {
    step: '06',
