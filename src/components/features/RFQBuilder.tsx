              ...
              return (
                ...
                >
                  ...
                  <div className={`text-[10px] font-normal mt-0.5 ${isSelected ? 'text-sage-light' : 'text-charcoal-muted'}`}>
                    {opt === '95%' ? 'Popular' : opt === '99%' ? 'Pharma' : 'Grade'}
                  </div>
                </button>
              );
            })}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg bg-white border border-cream-dark text-sm text-charcoal focus:border-forest focus:ring-1 focus:ring-forest transition-colors"
            >
              <option value="25 KG Export Bags">25 KG Export Bags (Standard Multi-Wall)</option>
              <option value="25 KG Bags Palletized">25 KG Palletized &amp; Shrink Wrapped</option>
              <option value="Private Label Packing">Private Label Custom Packing</option>
            </select>
          </div>
        </div>
